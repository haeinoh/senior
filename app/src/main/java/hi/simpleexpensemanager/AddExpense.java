...
public class AddExpense extends StringRequest{
    ...
    public AddExpense(String expenseName, String expenseAmount, String expenseCategory, String expenseDate, Response.Listener<String> listener){
        super(Method.POST, URL, listener, null);
        parameters = new HashMap<String, String>();

        parameters.put("expenseName", expenseName);
        parameters.put("expenseAmount", expenseAmount);
